...
import org.apache.jmeter.protocol.dubbo.util.MD5Util;
...
//            + Constants.CONFIGURATORS_CATEGORY,
    ...
    public void notify(List<URL> urls) {
        ...
        for (URL url : urls) {
            String category = url.getParameter(com.alibaba.dubbo.common.Constants.CATEGORY_KEY, com.alibaba.dubbo.common.Constants.PROVIDERS_CATEGORY);
            if (com.alibaba.dubbo.common.Constants.EMPTY_PROTOCOL.equalsIgnoreCase(url.getProtocol())) { // NOTE: group and version in empty protocol is *
                ...
                if (services != null) {
                    ...
                    if (!com.alibaba.dubbo.common.Constants.ANY_VALUE.equals(group) && !com.alibaba.dubbo.common.Constants.ANY_VALUE.equals(version)) {
                        ...
                        for (Map.Entry<String, Map<String, URL>> serviceEntry : services.entrySet()) {
                            ...
                            if (this.getInterface(service).equals(url.getServiceInterface())
                                    && (com.alibaba.dubbo.common.Constants.ANY_VALUE.equals(group) || StringUtils.isEquals(group, this.getGroup(service)))
                                    && (com.alibaba.dubbo.common.Constants.ANY_VALUE.equals(version) || StringUtils.isEquals(version, this.getVersion(service)))) {
